...
sudo touch /etc/apt/sources.list.d/aldpro.list
sudo echo -e "deb https://download.astralinux.ru/aldpro/stable/repository-main/ 1.0.0 main" | sudo tee -a /etc/apt/sources.list.d/aldpro.list
...
sudo echo -e "Reboot your server"